...
public class SeedData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (posts.size() == 0) {
            ...
            Post post1 = new Post();
            post1.setTitle("Pirmas savininko blogas!");
            post1.setBody("Kam man viso to reikia, geras klausimas :D");
            post1.setAccount(account1);

            Post post2 = new Post();
            post2.setTitle("Antras savininko blogas!");
            post2.setBody("3 -ia nakties, mes vis dar cia");
